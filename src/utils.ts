...
export function buildPath(rect1: Rect, cPoint1: ConnectionPoint, rect2: Rect, cPoint2: ConnectionPoint): Point[] {
  ...
  if ((cPoint1.angle === 270 && cPoint2.angle === 270) || (cPoint1.angle === 270 && cPoint2.angle === 90) || (cPoint1.angle === 180 && (cPoint2.angle === 90 || cPoint2.angle === 270 || cPoint2.angle === 180))) {
    const path: Point[] = [cPoint1.point, offsetPoint1, { x: offsetPoint1.x, y: offsetPoint2.y }, offsetPoint2, cPoint2.point];
  ...
  if ((cPoint1.angle === 270 && cPoint2.angle === 180) || (cPoint1.angle === 0 && cPoint2.angle === 270)) {
    ...
    // if (rect1.position.x > rect2.position.x) {
    //   const addY = Math.abs((cPoint1.point.y - cPoint2.point.y) / 2) + cPoint1.point.y;
    //   path = [cPoint1.point, offsetPoint1, { x: offsetPoint1.x, y: addY }, { x: offsetPoint2.x, y: addY }, offsetPoint2, cPoint2.point];
    // } else {
    //   path = [cPoint1.point, offsetPoint1, { x: offsetPoint1.x, y: offsetPoint2.y }, offsetPoint2, cPoint2.point];
    // }
  }
