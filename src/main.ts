import './style.css'
import { buildPath, ConnectionPoint, Point, Rect } from "./utils";
...
// const cPoint1: ConnectionPoint = { point: { x: 100, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 300, y: 250 }, angle: 90 };

// const cPoint1: ConnectionPoint = { point: { x: 100, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 300, y: 350 }, angle: 270 };

// const cPoint1: ConnectionPoint = { point: { x: 100, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 375, y: 300 }, angle: 0 };

// const cPoint1: ConnectionPoint = { point: { x: 100, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 225, y: 300 }, angle: 180 };


/// jdhwjd
// const cPoint1: ConnectionPoint = { point: { x: 100, y: 125 }, angle: 270};
// const cPoint2: ConnectionPoint = { point: { x: 300, y: 250 }, angle: 90 };
...
// const cPoint1: ConnectionPoint = { point: { x: 50, y: 100 }, angle: 180 };
// const cPoint2: ConnectionPoint = { point: { x: 300, y: 250 }, angle: 90 };
...
// const rect1: Rect = {
//   position: { x: 400, y: 100 }, // верхняя правая часть холста
//   size: { width: 100, height: 50 },
// };

// const rect2: Rect = {
//   position: { x: 100, y: 400 }, // нижняя левая часть холста
//   size: { width: 150, height: 100 },
// };

// 1
// const cPoint1: ConnectionPoint = { point: { x: 400, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 100, y: 350 }, angle: 90 };

// const cPoint1: ConnectionPoint = { point: { x: 400, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 100, y: 450 }, angle: 270 };

// const cPoint1: ConnectionPoint = { point: { x: 400, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 25, y: 400 }, angle: 180 };

// 4
// const cPoint1: ConnectionPoint = { point: { x: 400, y: 75 }, angle: 90 };
// const cPoint2: ConnectionPoint = { point: { x: 175, y: 400 }, angle: 0 };

// const cPoint1: ConnectionPoint = { point: { x: 400, y: 125 }, angle: 270 };
// const cPoint2: ConnectionPoint = { point: { x: 100, y: 350 }, angle: 90 };
...
// const cPoint1: ConnectionPoint = { point: { x: 450, y: 100 }, angle: 0 };
// const cPoint2: ConnectionPoint = { point: { x: 100, y: 350 }, angle: 90 };
...
// const cPoint1: ConnectionPoint = { point: { x: 350, y: 100 }, angle: 180 };
// const cPoint2: ConnectionPoint = { point: { x: 100, y: 350 }, angle: 90 };
...
// const firstRect = rect1.position.x > rect2.position.x ? rect2 : rect1;
// const secondRect = rect1.position.x < rect2.position.x ? rect2 : rect1;

// const firstPoint = cPoint1.point.x > cPoint2.point.x ? cPoint2 : cPoint1;
// const secondPoint = cPoint1.point.x < cPoint2.point.x ? cPoint2 : cPoint1;

// const firstRect = rect1;
// const secondRect = rect2;

// const firstPoint = cPoint1
// const secondPoint = cPoint2;


// const pathPoints = buildPath(firstRect, firstPoint, secondRect, secondPoint);
...
// const path2to1 = buildPath(rect2, connectionPoint2, rect1, connectionPoint1);
// renderer.drawLine(path2to1, 'yellow');
...
// const path3to1 = buildPath(rect3, connectionPoint3, rect1, connectionPoint1);
// renderer.drawLine(path3to1, 'red');
...
// const path7to1 = buildPath(rect7, connectionPoint7, rect1, connectionPoint1);
// renderer.drawLine(path7to1, 'red');
...
// const path8to1 = buildPath(rect8, connectionPoint8, rect1, connectionPoint1);
// renderer.drawLine(path8to1, 'red');
...
// const path1to9 = buildPath(rect9, connectionPoint9, rect1, connectionPoint1);
// renderer.drawLine(path1to9, 'red');